module.exports = {
    ...
    ads: [
        ...
        'Join AnalogAI now -> **4x Faster OpenAI models** at **3x cheaper model rates than official OpenAI**! Every OpenAI model available including GPT-4-32K : <https://api.analogai.in/register?aff=OU9f>',
        'Join AnalogAI now -> **4x Faster OpenAI models** at **3x cheaper model rates than official OpenAI**! Every OpenAI model available including GPT-4-32K : <https://api.analogai.in/register?aff=OU9f>',
        'Join AnalogAI now -> **4x Faster OpenAI models** at **3x cheaper model rates than official OpenAI**! Every OpenAI model available including GPT-4-32K : <https://api.analogai.in/register?aff=OU9f>'
    ]
};